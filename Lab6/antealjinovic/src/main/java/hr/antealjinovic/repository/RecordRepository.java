...
public interface RecordRepository extends JpaRepository<Record, Long> {
    ...
    @Query("SELECT r FROM Record r WHERE r.device.id = :deviceID AND r.year = :year AND r.month = :month")
    Optional<Record> findRecordByDeviceIdAndYearAndMonth(Long deviceID, int year, int month);
